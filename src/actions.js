...
const ACTIONS = {
  walk:    { name: '走一走',   forms: ['normal', 'chibi'], intrusive: false, w: 22, auto: true },
  hop:     { name: '跳一下',   forms: ['normal'],            intrusive: false, w: 10, auto: true },
  spin:    { name: '转个圈',   forms: ['normal', 'chibi'], intrusive: false, w: 9,  auto: true },
  ...
  flutefly:{ name: '笛子乱飞', forms: ['normal'],            intrusive: false, w: 4,  auto: true },
